// Package kcloak is a golang keycloak adaptor.
package kcloak
...
import (
	...
	"github.com/WilfredDube/kcloak/pkg/jwx"
)

// KCloak provides functionalities to talk to Keycloak.
type KCloak struct {
	basePath    string
	certsCache  sync.Map
...
func (g *KCloak) compareVersions(ctx context.Context, v, token string) (int, error) {
...
func (g *KCloak) getServerVersion(ctx context.Context, token string) (string, error) {
	if g.Config.version != "" {
...
func (g *KCloak) GetRequest(ctx context.Context) *resty.Request {
...
func (g *KCloak) GetRequestWithBearerAuthNoCache(ctx context.Context, token string) *resty.Request {
...
func (g *KCloak) GetRequestWithBearerAuth(ctx context.Context, token string) *resty.Request {
	return g.GetRequest(ctx).
		SetAuthToken(token).
		SetHeader("Content-Type", "application/json")
}
...
func (g *KCloak) GetRequestWithBearerAuthXMLHeader(ctx context.Context, token string) *resty.Request {
	return g.GetRequest(ctx).
		SetAuthToken(token).
...
func (g *KCloak) GetRequestWithBasicAuth(ctx context.Context, clientID, clientSecret string) *resty.Request {
...
func (g *KCloak) getRequestingParty(ctx context.Context, token string, realm string, options RequestingPartyTokenOptions, res interface{}) (*resty.Response, error) {
...
func NewClient(basePath string, options ...func(*KCloak)) *KCloak {
	c := KCloak{
...
func (g *KCloak) RestyClient() *resty.Client {
	return g.restyClient
}

// SetRestyClient overwrites the internal resty g.
func (g *KCloak) SetRestyClient(restyClient *resty.Client) {
	g.restyClient = restyClient
}

func (g *KCloak) getRealmURL(realm string, path ...string) string {
	path = append([]string{g.basePath, g.Config.authRealms, realm}, path...)
	return makeURL(path...)
}

func (g *KCloak) getAdminRealmURL(realm string, path ...string) string {
	path = append([]string{g.basePath, g.Config.authAdminRealms, realm}, path...)
	return makeURL(path...)
}

func (g *KCloak) getAttackDetectionURL(realm string, user string, path ...string) string {
...
func SetLegacyWildFlySupport() func(g *KCloak) {
	return func(g *KCloak) {
...
func SetAuthRealms(url string) func(g *KCloak) {
	return func(g *KCloak) {
...
func SetAuthAdminRealms(url string) func(g *KCloak) {
	return func(g *KCloak) {
...
func SetTokenEndpoint(url string) func(g *KCloak) {
	return func(g *KCloak) {
...
func SetRevokeEndpoint(url string) func(g *KCloak) {
	return func(g *KCloak) {
...
func SetLogoutEndpoint(url string) func(g *KCloak) {
	return func(g *KCloak) {
...
func SetOpenIDConnectEndpoint(url string) func(g *KCloak) {
	return func(g *KCloak) {
...
func SetCertCacheInvalidationTime(duration time.Duration) func(g *KCloak) {
	return func(g *KCloak) {
...
func (g *KCloak) GetServerInfo(ctx context.Context, accessToken string) (*ServerInfoRepresentation, error) {
...
func (g *KCloak) GetUserInfo(ctx context.Context, accessToken, realm string) (*UserInfo, error) {
...
func (g *KCloak) GetRawUserInfo(ctx context.Context, accessToken, realm string) (map[string]interface{}, error) {
	const errMessage = "could not get user info"
...
func (g *KCloak) getNewCerts(ctx context.Context, realm string) (*CertResponse, error) {
...
func (g *KCloak) GetCerts(ctx context.Context, realm string) (*CertResponse, error) {
...
func (g *KCloak) GetIssuer(ctx context.Context, realm string) (*IssuerResponse, error) {
...
func (g *KCloak) RetrospectToken(ctx context.Context, accessToken, clientID, clientSecret, realm string) (*IntroSpectTokenResult, error) {
...
func (g *KCloak) decodeAccessTokenWithClaims(ctx context.Context, accessToken, realm string, claims jwt.Claims) (*jwt.Token, error) {
...
func (g *KCloak) DecodeAccessToken(ctx context.Context, accessToken, realm string) (*jwt.Token, *jwt.MapClaims, error) {
...
func (g *KCloak) DecodeAccessTokenCustomClaims(ctx context.Context, accessToken, realm string, claims jwt.Claims) (*jwt.Token, error) {
	return g.decodeAccessTokenWithClaims(ctx, accessToken, realm, claims)
}

// GetToken uses TokenOptions to fetch a token.
func (g *KCloak) GetToken(ctx context.Context, realm string, options TokenOptions) (*JWT, error) {
...
func (g *KCloak) GetRequestingPartyToken(ctx context.Context, token, realm string, options RequestingPartyTokenOptions) (*JWT, error) {
...
func (g *KCloak) GetRequestingPartyPermissions(ctx context.Context, token, realm string, options RequestingPartyTokenOptions) (*[]RequestingPartyPermission, error) {
	const errMessage = "could not get requesting party token"
...
func (g *KCloak) GetRequestingPartyPermissionDecision(ctx context.Context, token, realm string, options RequestingPartyTokenOptions) (*RequestingPartyPermissionDecision, error) {
	const errMessage = "could not get requesting party token"
...
func (g *KCloak) RefreshToken(ctx context.Context, refreshToken, clientID, clientSecret, realm string) (*JWT, error) {
...
func (g *KCloak) LoginAdmin(ctx context.Context, username, password, realm string) (*JWT, error) {
	return g.GetToken(ctx, realm, TokenOptions{
...
func (g *KCloak) LoginClient(ctx context.Context, clientID, clientSecret, realm string, scopes ...string) (*JWT, error) {
	opts := TokenOptions{
		ClientID:     &clientID,
		ClientSecret: &clientSecret,
...
func (g *KCloak) LoginClientTokenExchange(ctx context.Context, clientID, token, clientSecret, realm, targetClient, userID string) (*JWT, error) {
...
func (g *KCloak) DirectNakedImpersonationTokenExchange(ctx context.Context, clientID, clientSecret, realm, userID string) (*JWT, error) {
	tokenOptions := TokenOptions{
		ClientID:           &clientID,
		ClientSecret:       &clientSecret,
		GrantType:          StringP("urn:ietf:params:oauth:grant-type:token-exchange"),
...
func (g *KCloak) LoginClientSignedJWT(
	ctx context.Context,
	clientID,
	realm string,
	key interface{},
...
func (g *KCloak) Login(ctx context.Context, clientID, clientSecret, realm, username, password string) (*JWT, error) {
	return g.GetToken(ctx, realm, TokenOptions{
		ClientID:     &clientID,
		ClientSecret: &clientSecret,
		GrantType:    StringP("password"),
...
func (g *KCloak) LoginOtp(ctx context.Context, clientID, clientSecret, realm, username, password, totp string) (*JWT, error) {
	return g.GetToken(ctx, realm, TokenOptions{
		ClientID:     &clientID,
		ClientSecret: &clientSecret,
		GrantType:    StringP("password"),
...
func (g *KCloak) Logout(ctx context.Context, clientID, clientSecret, realm, refreshToken string) error {
...
func (g *KCloak) LogoutPublicClient(ctx context.Context, clientID, realm, accessToken, refreshToken string) error {
...
func (g *KCloak) LogoutAllSessions(ctx context.Context, accessToken, realm, userID string) error {
	const errMessage = "could not logout"
...
func (g *KCloak) RevokeUserConsents(ctx context.Context, accessToken, realm, userID, clientID string) error {
...
func (g *KCloak) LogoutUserSession(ctx context.Context, accessToken, realm, session string) error {
	const errMessage = "could not logout"
...
func (g *KCloak) ExecuteActionsEmail(ctx context.Context, token, realm string, params ExecuteActionsEmail) error {
...
func (g *KCloak) SendVerifyEmail(ctx context.Context, token, userID, realm string, params ...SendVerificationMailParams) error {
...
func (g *KCloak) CreateGroup(ctx context.Context, token, realm string, group Group) (string, error) {
...
func (g *KCloak) CreateChildGroup(ctx context.Context, token, realm, groupID string, group Group) (string, error) {
...
func (g *KCloak) CreateComponent(ctx context.Context, token, realm string, component Component) (string, error) {
...
func (g *KCloak) CreateClient(ctx context.Context, accessToken, realm string, newClient Client) (string, error) {
...
func (g *KCloak) CreateClientRepresentation(ctx context.Context, token, realm string, newClient Client) (*Client, error) {
...
func (g *KCloak) CreateClientRole(ctx context.Context, token, realm, idOfClient string, role Role) (string, error) {
...
func (g *KCloak) CreateClientScope(ctx context.Context, token, realm string, scope ClientScope) (string, error) {
...
func (g *KCloak) CreateClientScopeProtocolMapper(ctx context.Context, token, realm, scopeID string, protocolMapper ProtocolMappers) (string, error) {
...
func (g *KCloak) UpdateGroup(ctx context.Context, token, realm string, updatedGroup Group) error {
...
func (g *KCloak) UpdateGroupManagementPermissions(ctx context.Context, accessToken, realm string, idOfGroup string, managementPermissions ManagementPermissionRepresentation) (*ManagementPermissionRepresentation, error) {
...
func (g *KCloak) UpdateClient(ctx context.Context, token, realm string, updatedClient Client) error {
...
func (g *KCloak) UpdateClientRepresentation(ctx context.Context, accessToken, realm string, updatedClient Client) (*Client, error) {
...
func (g *KCloak) UpdateClientManagementPermissions(ctx context.Context, accessToken, realm string, idOfClient string, managementPermissions ManagementPermissionRepresentation) (*ManagementPermissionRepresentation, error) {
...
func (g *KCloak) UpdateRole(ctx context.Context, token, realm, idOfClient string, role Role) error {
...
func (g *KCloak) UpdateClientScope(ctx context.Context, token, realm string, scope ClientScope) error {
...
func (g *KCloak) UpdateClientScopeProtocolMapper(ctx context.Context, token, realm, scopeID string, protocolMapper ProtocolMappers) error {
	const errMessage = "could not update client scope"
...
func (g *KCloak) DeleteGroup(ctx context.Context, token, realm, groupID string) error {
...
func (g *KCloak) DeleteClient(ctx context.Context, token, realm, idOfClient string) error {
...
func (g *KCloak) DeleteComponent(ctx context.Context, token, realm, componentID string) error {
...
func (g *KCloak) DeleteClientRepresentation(ctx context.Context, accessToken, realm, clientID string) error {
...
func (g *KCloak) DeleteClientRole(ctx context.Context, token, realm, idOfClient, roleName string) error {
...
func (g *KCloak) DeleteClientScope(ctx context.Context, token, realm, scopeID string) error {
...
func (g *KCloak) DeleteClientScopeProtocolMapper(ctx context.Context, token, realm, scopeID, protocolMapperID string) error {
	const errMessage = "could not delete client scope"
...
func (g *KCloak) GetClient(ctx context.Context, token, realm, idOfClient string) (*Client, error) {
...
func (g *KCloak) GetClientRepresentation(ctx context.Context, accessToken, realm, clientID string) (*Client, error) {
...
func (g *KCloak) GetAdapterConfiguration(ctx context.Context, accessToken, realm, clientID string) (*AdapterConfiguration, error) {
...
func (g *KCloak) GetClientsDefaultScopes(ctx context.Context, token, realm, idOfClient string) ([]*ClientScope, error) {
...
func (g *KCloak) AddDefaultScopeToClient(ctx context.Context, token, realm, idOfClient, scopeID string) error {
...
func (g *KCloak) RemoveDefaultScopeFromClient(ctx context.Context, token, realm, idOfClient, scopeID string) error {
...
func (g *KCloak) GetClientsOptionalScopes(ctx context.Context, token, realm, idOfClient string) ([]*ClientScope, error) {
...
func (g *KCloak) AddOptionalScopeToClient(ctx context.Context, token, realm, idOfClient, scopeID string) error {
...
func (g *KCloak) RemoveOptionalScopeFromClient(ctx context.Context, token, realm, idOfClient, scopeID string) error {
...
func (g *KCloak) GetDefaultOptionalClientScopes(ctx context.Context, token, realm string) ([]*ClientScope, error) {
...
func (g *KCloak) GetDefaultDefaultClientScopes(ctx context.Context, token, realm string) ([]*ClientScope, error) {
...
func (g *KCloak) GetClientScope(ctx context.Context, token, realm, scopeID string) (*ClientScope, error) {
...
func (g *KCloak) GetClientScopes(ctx context.Context, token, realm string) ([]*ClientScope, error) {
...
func (g *KCloak) GetClientScopeProtocolMappers(ctx context.Context, token, realm, scopeID string) ([]*ProtocolMappers, error) {
...
func (g *KCloak) GetClientScopeProtocolMapper(ctx context.Context, token, realm, scopeID, protocolMapperID string) (*ProtocolMappers, error) {
	const errMessage = "could not get client scope protocol mappers"
...
func (g *KCloak) GetClientScopeMappings(ctx context.Context, token, realm, idOfClient string) (*MappingsRepresentation, error) {
...
func (g *KCloak) GetRealmRoleGroups(ctx context.Context, token, roleName, realm string) ([]*Group, error) {
...
func (g *KCloak) GetClientScopeMappingsRealmRoles(ctx context.Context, token, realm, idOfClient string) ([]*Role, error) {
...
func (g *KCloak) GetClientScopeMappingsRealmRolesAvailable(ctx context.Context, token, realm, idOfClient string) ([]*Role, error) {
...
func (g *KCloak) CreateClientScopeMappingsRealmRoles(ctx context.Context, token, realm, idOfClient string, roles []Role) error {
...
func (g *KCloak) DeleteClientScopeMappingsRealmRoles(ctx context.Context, token, realm, idOfClient string, roles []Role) error {
...
func (g *KCloak) GetClientScopeMappingsClientRoles(ctx context.Context, token, realm, idOfClient, idOfSelectedClient string) ([]*Role, error) {
...
func (g *KCloak) GetClientScopeMappingsClientRolesAvailable(ctx context.Context, token, realm, idOfClient, idOfSelectedClient string) ([]*Role, error) {
...
func (g *KCloak) CreateClientScopeMappingsClientRoles(ctx context.Context, token, realm, idOfClient, idOfSelectedClient string, roles []Role) error {
...
func (g *KCloak) DeleteClientScopeMappingsClientRoles(ctx context.Context, token, realm, idOfClient, idOfSelectedClient string, roles []Role) error {
...
func (g *KCloak) GetClientSecret(ctx context.Context, token, realm, idOfClient string) (*CredentialRepresentation, error) {
...
func (g *KCloak) GetClientServiceAccount(ctx context.Context, token, realm, idOfClient string) (*User, error) {
...
func (g *KCloak) RegenerateClientSecret(ctx context.Context, token, realm, idOfClient string) (*CredentialRepresentation, error) {
...
func (g *KCloak) GetClientOfflineSessions(ctx context.Context, token, realm, idOfClient string, params ...GetClientUserSessionsParams) ([]*UserSessionRepresentation, error) {
...
func (g *KCloak) GetClientUserSessions(ctx context.Context, token, realm, idOfClient string, params ...GetClientUserSessionsParams) ([]*UserSessionRepresentation, error) {
...
func (g *KCloak) CreateClientProtocolMapper(ctx context.Context, token, realm, idOfClient string, mapper ProtocolMapperRepresentation) (string, error) {
...
func (g *KCloak) UpdateClientProtocolMapper(ctx context.Context, token, realm, idOfClient, mapperID string, mapper ProtocolMapperRepresentation) error {
...
func (g *KCloak) DeleteClientProtocolMapper(ctx context.Context, token, realm, idOfClient, mapperID string) error {
...
func (g *KCloak) GetKeyStoreConfig(ctx context.Context, token, realm string) (*KeyStoreConfig, error) {
...
func (g *KCloak) GetComponents(ctx context.Context, token, realm string) ([]*Component, error) {
...
func (g *KCloak) GetComponentsWithParams(ctx context.Context, token, realm string, params GetComponentsParams) ([]*Component, error) {
	const errMessage = "could not get components"
	var result []*Component
...
func (g *KCloak) GetComponent(ctx context.Context, token, realm string, componentID string) (*Component, error) {
	const errMessage = "could not get components"
	var result *Component
...
func (g *KCloak) UpdateComponent(ctx context.Context, token, realm string, component Component) error {
...
func (g *KCloak) GetDefaultGroups(ctx context.Context, token, realm string) ([]*Group, error) {
...
func (g *KCloak) AddDefaultGroup(ctx context.Context, token, realm, groupID string) error {
...
func (g *KCloak) RemoveDefaultGroup(ctx context.Context, token, realm, groupID string) error {
...
func (g *KCloak) getRoleMappings(ctx context.Context, token, realm, path, objectID string) (*MappingsRepresentation, error) {
...
func (g *KCloak) GetRoleMappingByGroupID(ctx context.Context, token, realm, groupID string) (*MappingsRepresentation, error) {
	return g.getRoleMappings(ctx, token, realm, "groups", groupID)
}

// GetRoleMappingByUserID gets the role mappings by user
func (g *KCloak) GetRoleMappingByUserID(ctx context.Context, token, realm, userID string) (*MappingsRepresentation, error) {
	return g.getRoleMappings(ctx, token, realm, "users", userID)
}

// GetGroup get group with id in realm
func (g *KCloak) GetGroup(ctx context.Context, token, realm, groupID string) (*Group, error) {
...
func (g *KCloak) GetChildGroups(ctx context.Context, token, realm, groupID string, params GetChildGroupsParams) ([]*Group, error) {
...
func (g *KCloak) GetGroupByPath(ctx context.Context, token, realm, groupPath string) (*Group, error) {
	const errMessage = "could not get group"
...
func (g *KCloak) GetGroups(ctx context.Context, token, realm string, params GetGroupsParams) ([]*Group, error) {
...
func (g *KCloak) GetGroupManagementPermissions(ctx context.Context, token, realm string, idOfGroup string) (*ManagementPermissionRepresentation, error) {
...
func (g *KCloak) GetGroupsByRole(ctx context.Context, token, realm string, roleName string) ([]*Group, error) {
	const errMessage = "could not get groups"
...
func (g *KCloak) GetGroupsByClientRole(ctx context.Context, token, realm string, roleName string, clientID string) ([]*Group, error) {
	const errMessage = "could not get groups"
...
func (g *KCloak) GetGroupsCount(ctx context.Context, token, realm string, params GetGroupsParams) (int, error) {
...
func (g *KCloak) GetGroupMembers(ctx context.Context, token, realm, groupID string, params GetGroupsParams) ([]*User, error) {
...
func (g *KCloak) GetClientRoles(ctx context.Context, token, realm, idOfClient string, params GetRoleParams) ([]*Role, error) {
...
func (g *KCloak) GetClientRoleByID(ctx context.Context, token, realm, roleID string) (*Role, error) {
...
func (g *KCloak) GetClientRolesByUserID(ctx context.Context, token, realm, idOfClient, userID string) ([]*Role, error) {
...
func (g *KCloak) GetClientRolesByGroupID(ctx context.Context, token, realm, idOfClient, groupID string) ([]*Role, error) {
...
func (g *KCloak) GetCompositeClientRolesByRoleID(ctx context.Context, token, realm, idOfClient, roleID string) ([]*Role, error) {
...
func (g *KCloak) GetCompositeClientRolesByUserID(ctx context.Context, token, realm, idOfClient, userID string) ([]*Role, error) {
...
func (g *KCloak) GetAvailableClientRolesByUserID(ctx context.Context, token, realm, idOfClient, userID string) ([]*Role, error) {
...
func (g *KCloak) GetAvailableClientRolesByGroupID(ctx context.Context, token, realm, idOfClient, groupID string) ([]*Role, error) {
	const errMessage = "could not get available client roles by user id"
...
func (g *KCloak) GetCompositeClientRolesByGroupID(ctx context.Context, token, realm, idOfClient, groupID string) ([]*Role, error) {
...
func (g *KCloak) GetClientRole(ctx context.Context, token, realm, idOfClient, roleName string) (*Role, error) {
	const errMessage = "could not get client role"
...
func (g *KCloak) GetClients(ctx context.Context, token, realm string, params GetClientsParams) ([]*Client, error) {
...
// to the managed permissions
func (g *KCloak) GetClientManagementPermissions(ctx context.Context, token, realm string, idOfClient string) (*ManagementPermissionRepresentation, error) {
	const errMessage = "could not get management permissions"
...
func (g *KCloak) CreateRealmRole(ctx context.Context, token string, realm string, role Role) (string, error) {
...
func (g *KCloak) GetRealmRole(ctx context.Context, token, realm, roleName string) (*Role, error) {
...
func (g *KCloak) GetRealmRoleByID(ctx context.Context, token, realm, roleID string) (*Role, error) {
	const errMessage = "could not get realm role"
...
func (g *KCloak) GetRealmRoles(ctx context.Context, token, realm string, params GetRoleParams) ([]*Role, error) {
...
func (g *KCloak) GetRealmRolesByUserID(ctx context.Context, token, realm, userID string) ([]*Role, error) {
...
func (g *KCloak) GetRealmRolesByGroupID(ctx context.Context, token, realm, groupID string) ([]*Role, error) {
...
func (g *KCloak) UpdateRealmRole(ctx context.Context, token, realm, roleName string, role Role) error {
...
func (g *KCloak) UpdateRealmRoleByID(ctx context.Context, token, realm, roleID string, role Role) error {
	const errMessage = "could not update realm role"
...
func (g *KCloak) DeleteRealmRole(ctx context.Context, token, realm, roleName string) error {
...
func (g *KCloak) AddRealmRoleToUser(ctx context.Context, token, realm, userID string, roles []Role) error {
...
func (g *KCloak) DeleteRealmRoleFromUser(ctx context.Context, token, realm, userID string, roles []Role) error {
...
func (g *KCloak) AddRealmRoleToGroup(ctx context.Context, token, realm, groupID string, roles []Role) error {
...
func (g *KCloak) DeleteRealmRoleFromGroup(ctx context.Context, token, realm, groupID string, roles []Role) error {
...
func (g *KCloak) AddRealmRoleComposite(ctx context.Context, token, realm, roleName string, roles []Role) error {
...
func (g *KCloak) DeleteRealmRoleComposite(ctx context.Context, token, realm, roleName string, roles []Role) error {
...
func (g *KCloak) GetCompositeRealmRoles(ctx context.Context, token, realm, roleName string) ([]*Role, error) {
...
func (g *KCloak) GetCompositeRolesByRoleID(ctx context.Context, token, realm, roleID string) ([]*Role, error) {
	const errMessage = "could not get composite client roles by role id"
...
func (g *KCloak) GetCompositeRealmRolesByRoleID(ctx context.Context, token, realm, roleID string) ([]*Role, error) {
	const errMessage = "could not get composite client roles by role id"
...
func (g *KCloak) GetCompositeRealmRolesByUserID(ctx context.Context, token, realm, userID string) ([]*Role, error) {
	const errMessage = "could not get composite client roles by user id"
...
func (g *KCloak) GetCompositeRealmRolesByGroupID(ctx context.Context, token, realm, groupID string) ([]*Role, error) {
	const errMessage = "could not get composite client roles by user id"
...
func (g *KCloak) GetAvailableRealmRolesByUserID(ctx context.Context, token, realm, userID string) ([]*Role, error) {
	const errMessage = "could not get available client roles by user id"
...
func (g *KCloak) GetAvailableRealmRolesByGroupID(ctx context.Context, token, realm, groupID string) ([]*Role, error) {
	const errMessage = "could not get available client roles by user id"
...
func (g *KCloak) GetRealm(ctx context.Context, token, realm string) (*RealmRepresentation, error) {
...
func (g *KCloak) GetRealms(ctx context.Context, token string) ([]*RealmRepresentation, error) {
...
func (g *KCloak) CreateRealm(ctx context.Context, token string, realm RealmRepresentation) (string, error) {
...
func (g *KCloak) UpdateRealm(ctx context.Context, token string, realm RealmRepresentation) error {
...
func (g *KCloak) DeleteRealm(ctx context.Context, token, realm string) error {
...
func (g *KCloak) ClearRealmCache(ctx context.Context, token, realm string) error {
...
func (g *KCloak) ClearUserCache(ctx context.Context, token, realm string) error {
...
func (g *KCloak) ClearKeysCache(ctx context.Context, token, realm string) error {
...
func (g *KCloak) GetAuthenticationFlows(ctx context.Context, token, realm string) ([]*AuthenticationFlowRepresentation, error) {
...
func (g *KCloak) GetAuthenticationFlow(ctx context.Context, token, realm string, authenticationFlowID string) (*AuthenticationFlowRepresentation, error) {
	const errMessage = "could not retrieve authentication flows"
	var result *AuthenticationFlowRepresentation
	resp, err := g.GetRequestWithBearerAuth(ctx, token).
		SetResult(&result).
...
func (g *KCloak) CreateAuthenticationFlow(ctx context.Context, token, realm string, flow AuthenticationFlowRepresentation) error {
...
func (g *KCloak) UpdateAuthenticationFlow(ctx context.Context, token, realm string, flow AuthenticationFlowRepresentation, authenticationFlowID string) (*AuthenticationFlowRepresentation, error) {
	const errMessage = "could not create authentication flows"
	var result *AuthenticationFlowRepresentation
	resp, err := g.GetRequestWithBearerAuth(ctx, token).
		SetResult(&result).SetBody(flow).
...
func (g *KCloak) DeleteAuthenticationFlow(ctx context.Context, token, realm, flowID string) error {
...
func (g *KCloak) GetAuthenticationExecutions(ctx context.Context, token, realm, flow string) ([]*ModifyAuthenticationExecutionRepresentation, error) {
	const errMessage = "could not retrieve authentication flows"
...
func (g *KCloak) CreateAuthenticationExecution(ctx context.Context, token, realm, flow string, execution CreateAuthenticationExecutionRepresentation) error {
...
func (g *KCloak) UpdateAuthenticationExecution(ctx context.Context, token, realm, flow string, execution ModifyAuthenticationExecutionRepresentation) error {
...
func (g *KCloak) DeleteAuthenticationExecution(ctx context.Context, token, realm, executionID string) error {
...
func (g *KCloak) CreateAuthenticationExecutionFlow(ctx context.Context, token, realm, flow string, executionFlow CreateAuthenticationExecutionFlowRepresentation) error {
...
func (g *KCloak) CreateUser(ctx context.Context, token, realm string, user User) (string, error) {
...
func (g *KCloak) DeleteUser(ctx context.Context, token, realm, userID string) error {
...
func (g *KCloak) GetUserByID(ctx context.Context, accessToken, realm, userID string) (*User, error) {
...
func (g *KCloak) GetUserCount(ctx context.Context, token string, realm string, params GetUsersParams) (int, error) {
...
func (g *KCloak) GetUserGroups(ctx context.Context, token, realm, userID string, params GetGroupsParams) ([]*Group, error) {
...
func (g *KCloak) GetUsers(ctx context.Context, token, realm string, params GetUsersParams) ([]*User, error) {
...
func (g *KCloak) GetUsersByRoleName(ctx context.Context, token, realm, roleName string, params GetUsersByRoleParams) ([]*User, error) {
...
func (g *KCloak) GetUsersByClientRoleName(ctx context.Context, token, realm, idOfClient, roleName string, params GetUsersByRoleParams) ([]*User, error) {
...
func (g *KCloak) SetPassword(ctx context.Context, token, userID, realm, password string, temporary bool) error {
...
func (g *KCloak) UpdateUser(ctx context.Context, token, realm string, user User) error {
...
func (g *KCloak) AddUserToGroup(ctx context.Context, token, realm, userID, groupID string) error {
...
func (g *KCloak) DeleteUserFromGroup(ctx context.Context, token, realm, userID, groupID string) error {
...
func (g *KCloak) GetUserSessions(ctx context.Context, token, realm, userID string) ([]*UserSessionRepresentation, error) {
...
func (g *KCloak) GetUserOfflineSessionsForClient(ctx context.Context, token, realm, userID, idOfClient string) ([]*UserSessionRepresentation, error) {
...
func (g *KCloak) AddClientRolesToUser(ctx context.Context, token, realm, idOfClient, userID string, roles []Role) error {
...
func (g *KCloak) AddClientRoleToUser(ctx context.Context, token, realm, idOfClient, userID string, roles []Role) error {
...
func (g *KCloak) AddClientRolesToGroup(ctx context.Context, token, realm, idOfClient, groupID string, roles []Role) error {
...
func (g *KCloak) AddClientRoleToGroup(ctx context.Context, token, realm, idOfClient, groupID string, roles []Role) error {
...
func (g *KCloak) DeleteClientRolesFromUser(ctx context.Context, token, realm, idOfClient, userID string, roles []Role) error {
...
func (g *KCloak) DeleteClientRoleFromUser(ctx context.Context, token, realm, idOfClient, userID string, roles []Role) error {
...
func (g *KCloak) DeleteClientRoleFromGroup(ctx context.Context, token, realm, idOfClient, groupID string, roles []Role) error {
...
func (g *KCloak) AddClientRoleComposite(ctx context.Context, token, realm, roleID string, roles []Role) error {
...
func (g *KCloak) DeleteClientRoleComposite(ctx context.Context, token, realm, roleID string, roles []Role) error {
...
func (g *KCloak) GetUserFederatedIdentities(ctx context.Context, token, realm, userID string) ([]*FederatedIdentityRepresentation, error) {
...
func (g *KCloak) CreateUserFederatedIdentity(ctx context.Context, token, realm, userID, providerID string, federatedIdentityRep FederatedIdentityRepresentation) error {
...
func (g *KCloak) DeleteUserFederatedIdentity(ctx context.Context, token, realm, userID, providerID string) error {
...
func (g *KCloak) GetUserBruteForceDetectionStatus(ctx context.Context, accessToken, realm, userID string) (*BruteForceStatus, error) {
...
func (g *KCloak) CreateIdentityProvider(ctx context.Context, token string, realm string, providerRep IdentityProviderRepresentation) (string, error) {
...
func (g *KCloak) GetIdentityProviders(ctx context.Context, token, realm string) ([]*IdentityProviderRepresentation, error) {
...
func (g *KCloak) GetIdentityProvider(ctx context.Context, token, realm, alias string) (*IdentityProviderRepresentation, error) {
...
func (g *KCloak) UpdateIdentityProvider(ctx context.Context, token, realm, alias string, providerRep IdentityProviderRepresentation) error {
...
func (g *KCloak) DeleteIdentityProvider(ctx context.Context, token, realm, alias string) error {
...
func (g *KCloak) ExportIDPPublicBrokerConfig(ctx context.Context, token, realm, alias string) (*string, error) {
...
func (g *KCloak) ImportIdentityProviderConfig(ctx context.Context, token, realm, fromURL, providerID string) (map[string]string, error) {
...
func (g *KCloak) ImportIdentityProviderConfigFromFile(ctx context.Context, token, realm, providerID, fileName string, fileBody io.Reader) (map[string]string, error) {
	const errMessage = "could not import config"
...
func (g *KCloak) CreateIdentityProviderMapper(ctx context.Context, token, realm, alias string, mapper IdentityProviderMapper) (string, error) {
...
func (g *KCloak) GetIdentityProviderMapper(ctx context.Context, token string, realm string, alias string, mapperID string) (*IdentityProviderMapper, error) {
...
func (g *KCloak) DeleteIdentityProviderMapper(ctx context.Context, token, realm, alias, mapperID string) error {
...
func (g *KCloak) GetIdentityProviderMappers(ctx context.Context, token, realm, alias string) ([]*IdentityProviderMapper, error) {
...
func (g *KCloak) GetIdentityProviderMapperByID(ctx context.Context, token, realm, alias, mapperID string) (*IdentityProviderMapper, error) {
	const errMessage = "could not get identity provider mappers"
...
func (g *KCloak) UpdateIdentityProviderMapper(ctx context.Context, token, realm, alias string, mapper IdentityProviderMapper) error {
...
func (g *KCloak) GetResource(ctx context.Context, token, realm, idOfClient, resourceID string) (*ResourceRepresentation, error) {
...
func (g *KCloak) GetResourceClient(ctx context.Context, token, realm, resourceID string) (*ResourceRepresentation, error) {
	const errMessage = "could not get resource"
...
func (g *KCloak) GetResources(ctx context.Context, token, realm, idOfClient string, params GetResourceParams) ([]*ResourceRepresentation, error) {
...
func (g *KCloak) GetResourcesClient(ctx context.Context, token, realm string, params GetResourceParams) ([]*ResourceRepresentation, error) {
	const errMessage = "could not get resources"
...
func (g *KCloak) GetResourceServer(ctx context.Context, token, realm, idOfClient string) (*ResourceServerRepresentation, error) {
...
func (g *KCloak) UpdateResource(ctx context.Context, token, realm, idOfClient string, resource ResourceRepresentation) error {
...
func (g *KCloak) UpdateResourceClient(ctx context.Context, token, realm string, resource ResourceRepresentation) error {
	const errMessage = "could not update resource"
...
func (g *KCloak) CreateResource(ctx context.Context, token, realm string, idOfClient string, resource ResourceRepresentation) (*ResourceRepresentation, error) {
...
func (g *KCloak) CreateResourceClient(ctx context.Context, token, realm string, resource ResourceRepresentation) (*ResourceRepresentation, error) {
	const errMessage = "could not create resource"
...
func (g *KCloak) DeleteResource(ctx context.Context, token, realm, idOfClient, resourceID string) error {
...
func (g *KCloak) DeleteResourceClient(ctx context.Context, token, realm, resourceID string) error {
	const errMessage = "could not delete resource"
...
func (g *KCloak) GetScope(ctx context.Context, token, realm, idOfClient, scopeID string) (*ScopeRepresentation, error) {
...
func (g *KCloak) GetScopes(ctx context.Context, token, realm, idOfClient string, params GetScopeParams) ([]*ScopeRepresentation, error) {
...
func (g *KCloak) CreateScope(ctx context.Context, token, realm, idOfClient string, scope ScopeRepresentation) (*ScopeRepresentation, error) {
...
func (g *KCloak) GetPermissionScope(ctx context.Context, token, realm, idOfClient string, idOfScope string) (*PolicyRepresentation, error) {
...
func (g *KCloak) UpdatePermissionScope(ctx context.Context, token, realm, idOfClient string, idOfScope string, policy PolicyRepresentation) error {
...
func (g *KCloak) UpdateScope(ctx context.Context, token, realm, idOfClient string, scope ScopeRepresentation) error {
...
func (g *KCloak) DeleteScope(ctx context.Context, token, realm, idOfClient, scopeID string) error {
...
func (g *KCloak) GetPolicy(ctx context.Context, token, realm, idOfClient, policyID string) (*PolicyRepresentation, error) {
...
func (g *KCloak) GetPolicies(ctx context.Context, token, realm, idOfClient string, params GetPolicyParams) ([]*PolicyRepresentation, error) {
...
func (g *KCloak) CreatePolicy(ctx context.Context, token, realm, idOfClient string, policy PolicyRepresentation) (*PolicyRepresentation, error) {
...
func (g *KCloak) UpdatePolicy(ctx context.Context, token, realm, idOfClient string, policy PolicyRepresentation) error {
...
func (g *KCloak) DeletePolicy(ctx context.Context, token, realm, idOfClient, policyID string) error {
...
func (g *KCloak) GetAuthorizationPolicyAssociatedPolicies(ctx context.Context, token, realm, idOfClient, policyID string) ([]*PolicyRepresentation, error) {
...
func (g *KCloak) GetAuthorizationPolicyResources(ctx context.Context, token, realm, idOfClient, policyID string) ([]*PolicyResourceRepresentation, error) {
...
func (g *KCloak) GetAuthorizationPolicyScopes(ctx context.Context, token, realm, idOfClient, policyID string) ([]*PolicyScopeRepresentation, error) {
...
func (g *KCloak) GetResourcePolicy(ctx context.Context, token, realm, permissionID string) (*ResourcePolicyRepresentation, error) {
...
func (g *KCloak) GetResourcePolicies(ctx context.Context, token, realm string, params GetResourcePoliciesParams) ([]*ResourcePolicyRepresentation, error) {
...
func (g *KCloak) CreateResourcePolicy(ctx context.Context, token, realm, resourceID string, policy ResourcePolicyRepresentation) (*ResourcePolicyRepresentation, error) {
...
func (g *KCloak) UpdateResourcePolicy(ctx context.Context, token, realm, permissionID string, policy ResourcePolicyRepresentation) error {
...
func (g *KCloak) DeleteResourcePolicy(ctx context.Context, token, realm, permissionID string) error {
...
func (g *KCloak) GetPermission(ctx context.Context, token, realm, idOfClient, permissionID string) (*PermissionRepresentation, error) {
...
func (g *KCloak) GetDependentPermissions(ctx context.Context, token, realm, idOfClient, policyID string) ([]*PermissionRepresentation, error) {
	const errMessage = "could not get permission"
...
func (g *KCloak) GetPermissionResources(ctx context.Context, token, realm, idOfClient, permissionID string) ([]*PermissionResource, error) {
...
func (g *KCloak) GetScopePermissions(ctx context.Context, token, realm, idOfClient, idOfScope string) ([]*PolicyRepresentation, error) {
...
func (g *KCloak) GetPermissionScopes(ctx context.Context, token, realm, idOfClient, permissionID string) ([]*PermissionScope, error) {
...
func (g *KCloak) GetPermissions(ctx context.Context, token, realm, idOfClient string, params GetPermissionParams) ([]*PermissionRepresentation, error) {
...
func (g *KCloak) CreatePermissionTicket(ctx context.Context, token, realm string, permissions []CreatePermissionTicketParams) (*PermissionTicketResponseRepresentation, error) {
...
func (g *KCloak) GrantUserPermission(ctx context.Context, token, realm string, permission PermissionGrantParams) (*PermissionGrantResponseRepresentation, error) {
...
func (g *KCloak) UpdateUserPermission(ctx context.Context, token, realm string, permission PermissionGrantParams) (*PermissionGrantResponseRepresentation, error) {
...
func (g *KCloak) GetUserPermissions(ctx context.Context, token, realm string, params GetUserPermissionParams) ([]*PermissionGrantResponseRepresentation, error) {
...
func (g *KCloak) DeleteUserPermission(ctx context.Context, token, realm, ticketID string) error {
...
func (g *KCloak) CreatePermission(ctx context.Context, token, realm, idOfClient string, permission PermissionRepresentation) (*PermissionRepresentation, error) {
...
func (g *KCloak) UpdatePermission(ctx context.Context, token, realm, idOfClient string, permission PermissionRepresentation) error {
...
func (g *KCloak) DeletePermission(ctx context.Context, token, realm, idOfClient, permissionID string) error {
...
func (g *KCloak) GetCredentialRegistrators(ctx context.Context, token, realm string) ([]string, error) {
...
func (g *KCloak) GetConfiguredUserStorageCredentialTypes(ctx context.Context, token, realm, userID string) ([]string, error) {
	const errMessage = "could not get user credential registrators"
...
func (g *KCloak) GetCredentials(ctx context.Context, token, realm, userID string) ([]*CredentialRepresentation, error) {
...
func (g *KCloak) DeleteCredentials(ctx context.Context, token, realm, userID, credentialID string) error {
...
func (g *KCloak) UpdateCredentialUserLabel(ctx context.Context, token, realm, userID, credentialID, userLabel string) error {
...
func (g *KCloak) DisableAllCredentialsByType(ctx context.Context, token, realm, userID string, types []string) error {
...
func (g *KCloak) MoveCredentialBehind(ctx context.Context, token, realm, userID, credentialID, newPreviousCredentialID string) error {
...
func (g *KCloak) MoveCredentialToFirst(ctx context.Context, token, realm, userID, credentialID string) error {
	const errMessage = "could not move credential"
...
func (g *KCloak) GetEvents(ctx context.Context, token string, realm string, params GetEventsParams) ([]*EventRepresentation, error) {
...
func (g *KCloak) GetClientScopesScopeMappingsRealmRolesAvailable(ctx context.Context, token, realm, clientScopeID string) ([]*Role, error) {
...
func (g *KCloak) GetClientScopesScopeMappingsRealmRoles(ctx context.Context, token, realm, clientScopeID string) ([]*Role, error) {
...
func (g *KCloak) DeleteClientScopesScopeMappingsRealmRoles(ctx context.Context, token, realm, clientScopeID string, roles []Role) error {
...
func (g *KCloak) CreateClientScopesScopeMappingsRealmRoles(ctx context.Context, token, realm, clientScopeID string, roles []Role) error {
...
func (g *KCloak) RegisterRequiredAction(ctx context.Context, token string, realm string, requiredAction RequiredActionProviderRepresentation) error {
...
func (g *KCloak) GetUnregisteredRequiredActions(ctx context.Context, token string, realm string) ([]*UnregisteredRequiredActionProviderRepresentation, error) {
...
func (g *KCloak) GetRequiredActions(ctx context.Context, token string, realm string) ([]*RequiredActionProviderRepresentation, error) {
...
func (g *KCloak) GetRequiredAction(ctx context.Context, token string, realm string, alias string) (*RequiredActionProviderRepresentation, error) {
...
func (g *KCloak) UpdateRequiredAction(ctx context.Context, token string, realm string, requiredAction RequiredActionProviderRepresentation) error {
...
func (g *KCloak) DeleteRequiredAction(ctx context.Context, token string, realm string, alias string) error {
...
func (g *KCloak) CreateClientScopesScopeMappingsClientRoles(
...
// (not client's scope).
func (g *KCloak) GetClientScopesScopeMappingsClientRolesAvailable(ctx context.Context, token, realm, idOfClientScope, idOfClient string) ([]*Role, error) {
...
// (not client's scope).
func (g *KCloak) GetClientScopesScopeMappingsClientRoles(ctx context.Context, token, realm, idOfClientScope, idOfClient string) ([]*Role, error) {
...
// (not client's scope).
func (g *KCloak) DeleteClientScopesScopeMappingsClientRoles(ctx context.Context, token, realm, idOfClientScope, idOfClient string, roles []Role) error {
...
func (g *KCloak) RevokeToken(ctx context.Context, realm, clientID, clientSecret, refreshToken string) error {
...
func (g *KCloak) UpdateUsersManagementPermissions(ctx context.Context, accessToken, realm string, managementPermissions ManagementPermissionRepresentation) (*ManagementPermissionRepresentation, error) {
...
func (g *KCloak) GetUsersManagementPermissions(ctx context.Context, accessToken, realm string) (*ManagementPermissionRepresentation, error) {
...
func (g *KCloak) CreateOrganization(ctx context.Context, token, realm string, organization OrganizationRepresentation) (string, error) {
...
func (g *KCloak) GetOrganizations(ctx context.Context, token, realm string, params GetOrganizationsParams) ([]*OrganizationRepresentation, error) {
...
func (g *KCloak) DeleteOrganization(ctx context.Context, token, realm, idOfOrganization string) error {
...
func (g *KCloak) GetOrganizationByID(ctx context.Context, token, realm, idOfOrganization string) (*OrganizationRepresentation, error) {
...
func (g *KCloak) UpdateOrganization(ctx context.Context, token, realm string, organization OrganizationRepresentation) error {
...
func (g *KCloak) InviteUserToOrganizationByID(ctx context.Context, token, realm, idOfOrganization, userID string) error {
...
// An invitation email will be sent to the user so SMTP settings are required in keycloak
func (g *KCloak) InviteUserToOrganizationByEmail(ctx context.Context, token, realm, idOfOrganization string, userParams InviteeFormParams) error {
...
func (g *KCloak) AddUserToOrganization(ctx context.Context, token, realm, idOfOrganization, idOfUser string) error {
...
func (g *KCloak) RemoveUserFromOrganization(ctx context.Context, token, realm, idOfOrganization, idOfUser string) error {
...
func (g *KCloak) GetOrganizationMemberCount(ctx context.Context, token, realm, idOfOrganization string) (int, error) {
...
func (g *KCloak) GetOrganizationMemberByID(ctx context.Context, token, realm, idOfOrganization, idOfUser string) (*MemberRepresentation, error) {
...
func (g *KCloak) GetOrganizationMembers(ctx context.Context, token, realm, idOfOrganization string, params GetMembersParams) ([]*MemberRepresentation, error) {
...
func (g *KCloak) GetMemberAssociatedOrganizations(ctx context.Context, token, realm, idOfUser string) ([]*OrganizationRepresentation, error) {
